...
abstract class MySqlDatabase extends UFDatabase implements DatabaseInterface {
    ...
    public static function getTables(){
        ...
        $test_list = [
            ...
            static::getTable('bud')->name,
            static::getTable('votes_bud')->name,
            static::getTable('coleg')->name,
            static::getTable('votes_coleg')->name,
            static::getTable('pbidea')->name,
            static::getTable('votes_pbidea')->name
        ];
