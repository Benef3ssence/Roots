...
namespace UserFrosting;
        ...
        class MySqlColegLoader extends MySqlObjectLoader implements ColegLoaderInterface{
            ...
            public static function fetch($value, $name = "id"){
                ...
                if ($results)
                    return new MySqlColeg($results, $results['id']);
                else
                    return false;
            }
            ...
            public static function fetchAll($value = null, $name = null){
                ...
                foreach ($resultArr as $id => $group)
                    $results[$id] = new MySqlColeg($group, $id);
                return $results;
            }
